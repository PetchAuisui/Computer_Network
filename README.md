...
interface Vlan10
 ip address 192.51.1.1 255.255.255.0
 no shutdown
interface Vlan20
 ip address 192.51.2.1 255.255.255.0
 no shutdown
...
interface GigabitEthernet0/1
 description to-R1
 no switchport
 ip address 192.51.3.2 255.255.255.252
 no shutdown

! --- ลิงก์ขึ้นอาคาร (ไป SW1-4) เป็น trunk ---
...
router ospf 1
 router-id 1.1.1.1
 network 192.51.1.0 0.0.0.255 area 0
 network 192.51.2.0 0.0.0.255 area 0
 network 192.51.3.0 0.0.0.3   area 0
...
interface GigabitEthernet0/0/1
 ...
 ip address 192.51.3.1 255.255.255.252
 no shutdown
...
! อัปลิงก์ขึ้น CoreSW เป็น trunk
interface FastEthernet0/1
 description uplink-to-CoreSW
 switchport mode trunk
 no shutdown

! พอร์ตลง PC: VLAN10 และ VLAN20
interface FastEthernet0/2
